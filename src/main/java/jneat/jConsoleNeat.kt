...
import jneat.Evolution.Experiment3

object jConsoleNeat {
    @JvmStatic
    fun main(args: Array<String>) {
        Neat.initbase()
        var nome = "c:\\jneat\\dati\\parametri"
        val nomeA: String? = null
        val nomeB: String? = null


        //  String nome = "c:\\neat_v2\\evolution\\parametri.ne";
        val rc = Neat.readParam(nome)
        if (rc) println(" okay read ") else println(" error in read ")
	  ...
	  */
        ...
        //
        Experiment3(20, NeatConstant.COLD, 1)
